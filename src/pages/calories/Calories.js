...
export default function Calories({ id }) {
      ...
      <div id={id} className={styles.slide}>
        <div className={styles["text-container"]}>
          ...
          <p>
            ...
            Celsius. That means when we're talking about calories from food,
            we're talking about how much energy we get from eating that food.
          </p>
          <p className="italic">
